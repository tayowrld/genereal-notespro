...
export function Sidebar() {
  ...
  const [pinnedSheets] = useState([
    { id: 1, title: "Важная заметка", icon: FileText },
    { id: 2, title: "Календарь", icon: FileText },
    { id: 3, title: "Задачи", icon: FileText },
  ]);
          ...
          <div className="p-4 space-y-6">
            ...
            <div className="space-y-1">
              <NavLink
                to="/main"
                className={({ isActive }) =>
                  `flex items-center space-x-3 px-2 py-2 rounded-lg hover:bg-accent ${
                    isActive ? "bg-accent" : ""
                  }`
                }
              >
