...
export function Sidebar() {
  ...
  return <div className="w-64 border-r bg-background flex flex-col animate-slideIn">
          ...
          <div className="p-4 space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between px-2">
                ...
                <Button variant="ghost" size="icon" className="h-8 w-8 hover:bg-accent transition-colors" onClick={handleNewSheet}>
                  <Plus className="h-4 w-4" />
                </Button>
              </div>
              <div className="space-y-1">
                {pinnedSheets.map(sheet => <Button key={sheet.id} variant="ghost" className="w-full justify-start animate-fadeIn" asChild>
      ...
      <div className="p-4 border-t">
        <Button variant="ghost" size="icon" onClick={() => setIsDarkMode(!isDarkMode)} className="w-full flex items-center justify-center transition-colors">
